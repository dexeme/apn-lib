...
function main()
    ...
    open(OUTPUT_PATH, "w") do io
        println(io, "# This file is generated by scripts/generate_kaleyski_table1_luts.jl.")
        println(io, "# Do not edit it by hand; edit test/kaleyski_table1_data.jl instead.")
        println(io)
