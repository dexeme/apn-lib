...
function main()
    ...
    open(OUTPUT_PATH, "w") do io
        println(io, "# This file is generated by experiments/Deciding_EA_equivalence_via_invariants/generate_luts.jl.")
        println(io, "# Do not edit it by hand; edit experiments/Deciding_EA_equivalence_via_invariants/table1_data.jl instead.")
        println(io)
