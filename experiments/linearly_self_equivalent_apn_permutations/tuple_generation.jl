...
function proposition4_filter(A::FqMatrix, B::FqMatrix, n::Int)::Bool
    check_gf2_matrix(A, n, name = "A")
    check_gf2_matrix(B, n, name = "B")
...
function proposition4_filter(A::AbstractMatrix, B::AbstractMatrix, n::Int)::Bool
    return proposition4_filter(gf2_matrix(A, n, name = "A"), gf2_matrix(B, n, name = "B"), n)
end

function gf2_matrix(A::AbstractMatrix, n::Int; name::String = "Matrix")
...
function gf2_bitmatrix(A::FqMatrix, n::Int; name::String = "Matrix")::BitMatrix
...
function gf2_bitmatrix(A::AbstractMatrix, n::Int; name::String = "Matrix")::BitMatrix
    check_n_by_n_matrix(A, n, name = name)
    matrix_bits = falses(n, n)
...
function proposition5_filter(A, B, n::Int)::Bool
    A_bit = gf2_bitmatrix(A, n, name = "A")
    B_bit = gf2_bitmatrix(B, n, name = "B")
