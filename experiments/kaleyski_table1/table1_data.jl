...
const KALEYSKI_TABLE1_DEFINITIONS = [
    APNDefinition(6, "1.1", "x^3",
        xpow(3)),
    APNDefinition(6, "1.2", "(No. 1.1) + u*(tr(u^56*x^3) + tr_8/2(u^18*x^9))",
        reference("1.1"),
        absolute_trace(trace_term(56, 3); scale = 1),
        relative_trace(3, trace_term(18, 9); scale = 1)),
    APNDefinition(6, "2.3", "2.1", "x^3 + u*x^24 + x^10",
        xpow(3), APNLib.monomial(1, 24), xpow(10)),
    APNDefinition(6, "2.4", "2.2", "(No. 2.1) + u^3*(tr(u^10*x^3 + u^53*x^5) + tr_8/2(u^36*x^9))",
        reference("2.1"),
        absolute_trace(trace_term(10, 3), trace_term(53, 5); scale = 3),
        relative_trace(3, trace_term(36, 9); scale = 3)),
    APNDefinition(6, "2.7", "2.3", "(No. 2.1) + tr(u^34*x^3 + u^48*x^5) + tr_8/2(u^9*x^9)",
        reference("2.1"),
        absolute_trace(trace_term(34, 3), trace_term(48, 5)),
        relative_trace(3, trace_term(9, 9))),
    APNDefinition(6, "2.10", "2.4", "(No. 2.1) + u^2*(tr(u^24*x^3 + u^28*x^5) + tr_8/2(x^9))",
        reference("2.1"),
        absolute_trace(trace_term(24, 3), trace_term(28, 5); scale = 2),
        relative_trace(3, trace_term(0, 9); scale = 2)),
    APNDefinition(6, "2.1", "2.5", "(No. 2.3) + u^42*(tr(u^10*x^3 + u^51*x^5) + tr_8/2(u^9*x^9))",
        reference("2.3"),
        absolute_trace(trace_term(10, 3), trace_term(51, 5); scale = 42),
        relative_trace(3, trace_term(9, 9); scale = 42)),
    APNDefinition(6, "2.5", "2.6", "(No. 2.3) + u^23*(tr(u^31*x^3 + u^49*x^5) + tr_8/2(u^9*x^9))",
        reference("2.3"),
        absolute_trace(trace_term(31, 3), trace_term(49, 5); scale = 23),
        relative_trace(3, trace_term(9, 9); scale = 23)),
    APNDefinition(6, "2.6", "2.7", "(No. 2.3) + u^12*(tr(u^42*x^3 + u^13*x^5) + tr_8/2(u^54*x^9))",
        reference("2.3"),
        absolute_trace(trace_term(42, 3), trace_term(13, 5); scale = 12),
        relative_trace(3, trace_term(54, 9); scale = 12)),
    APNDefinition(6, "2.8", "(No. 2.3) + u*(tr(u^51*x^3 + u^60*x^5) + tr_8/2(u^18*x^9))",
        reference("2.3"),
        absolute_trace(trace_term(51, 3), trace_term(60, 5); scale = 1),
        relative_trace(3, trace_term(18, 9); scale = 1)),
    APNDefinition(6, "2.9", "(No. 2.3) + u^14*(tr(u^18*x^3 + u^61*x^5) + tr_8/2(u^18*x^9))",
        reference("2.3"),
        absolute_trace(trace_term(18, 3), trace_term(61, 5); scale = 14),
        relative_trace(3, trace_term(18, 9); scale = 14)),
    APNDefinition(6, "2.11", "2.10", "(No. 2.3) + u^17*tr(u^50*x^3 + u^56*x^5)",
        reference("2.3"),
        absolute_trace(trace_term(50, 3), trace_term(56, 5); scale = 17)),
    APNDefinition(6, "2.12", "2.11", "(No. 2.3) + u^19*(tr(u^11*x^3 + u^7*x^5 + u^38*x^7 + u^61*x^11 + u^23*x^13) + tr_8/2(u^54*x^9) + tr_4/2(u^42*x^21))",
        reference("2.3"),
    ...
    APNDefinition(8, "1.14", "(No. 1.11) + u^5*tr(u^160*x^3 + u^250*x^9)",
        reference("1.11"), absolute_trace(trace_term(160, 3), trace_term(250, 9); scale = 5)),
    APNDefinition(8, "1.15", "(No. 1.11) + u^102*tr(u^6*x^3 + u^119*x^9)",
        reference("1.11"), absolute_trace(trace_term(6, 3), trace_term(119, 9); scale = 102)),
    APNDefinition(8, "1.16", "(No. 1.14) + u^64*tr(u^133*x^3 + u^30*x^9)",
        reference("1.14"), absolute_trace(trace_term(133, 3), trace_term(30, 9); scale = 64)),
    APNDefinition(8, "1.17", "(No. 1.16) + u^78*tr(u^235*x^3 + u^146*x^9)",
        reference("1.16"), absolute_trace(trace_term(235, 3), trace_term(146, 9); scale = 78)),
    APNDefinition(8, "2.1", "x^3 + x^17 + u^16*(x^18 + x^33) + u^15*x^48",
        xpow(3), xpow(17), APNLib.monomial(16, 18), APNLib.monomial(16, 33), APNLib.monomial(15, 48)),
    APNDefinition(8, "3.1", "x^3 + u^24*x^6 + u^182*x^132 + u^67*x^192",
        xpow(3), APNLib.monomial(24, 6), APNLib.monomial(182, 132), APNLib.monomial(67, 192)),
    APNDefinition(8, "4.1", "x^3 + x^6 + x^68 + x^80 + x^132 + x^160",
        xpow(3), xpow(6), xpow(68), xpow(80), xpow(132), xpow(160)),
    APNDefinition(8, "5.1", "x^3 + x^5 + x^18 + x^40 + x^66",
        xpow(3), xpow(5), xpow(18), xpow(40), xpow(66)),
    APNDefinition(8, "6.1", "x^3 + x^12 + x^40 + x^66 + x^130",
        xpow(3), xpow(12), xpow(40), xpow(66), xpow(130)),
    APNDefinition(8, "7.1", "x^57",
        xpow(57)),
]
